  ...
  return (
    <section className="px-6 py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <h2 className="mb-3 text-center font-[family-name:var(--font-display)] text-3xl font-extrabold tracking-tight sm:text-4xl">
          ...
          {TESTIMONIALS.map((testimonial, index) => (
            ...
            >
              ...
              <div className="mt-auto flex items-center gap-3">
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border-2 border-primary/30 bg-primary/10 font-[family-name:var(--font-display)] text-sm font-bold text-primary">
