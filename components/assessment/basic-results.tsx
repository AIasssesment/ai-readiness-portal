  ...
  return (
    <section className="animate-in fade-in px-6 py-20 bg-card">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mb-8 font-[family-name:var(--font-display)] text-3xl font-extrabold tracking-tight sm:text-4xl">
          RPA Readiness Score
        </h2>
        ...
        <div className="mx-auto mb-7 flex h-40 w-40 flex-col items-center justify-center rounded-full border-[6px] border-primary shadow-lg shadow-primary/20">
          <span className="font-[family-name:var(--font-display)] text-6xl font-extrabold text-primary">
            {overallScore}
          </span>
        ...
        {/* Tier */}
        <h3 className="mb-4 font-[family-name:var(--font-display)] text-2xl font-bold">
